...
export class SessionApi {
     ...
     */
    public async list1 (corpusId: string, pageSize?: number, pageIndex?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SessionListResponse;  }> {
        ...
        if (corpusId === null || corpusId === undefined) {
            throw new Error('Required parameter corpusId was null or undefined when calling list1.');
        }
